...
public class TFspecies  implements Serializable {
	...
	/**
	 * parses REPRESSES parameter and creates a list of map values: <Which TFspecie is repressed by this, Repression probability>
	*/
	/* not needed anymore
	...
	*/
	...
	public int parseDBD(Cell n, String dbd){
		...
		if(dbd.startsWith(Constants.DBD_TYPE_SEQ)){
			...
			//Utils.PCMtoPWM("/home/andrei/Politech/Laboratory/StoсhasticModelling/retfdynamics/tf8-2.pcm", n.TFspecies[1]);
			pfm = new PFM(dbd,n);
